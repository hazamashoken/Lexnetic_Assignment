...
@router.get(
	path="schools",
	response=list[SchoolOut],
	tags=["School"],
	summary="List all schools",
	description="Return List all schools with pagination",
)
@paginate
...
@router.get(
	...
	response={200: SchoolOut, 404: DetailOut},
	tags=["School"],
...
@router.get(
	"headmaster/{int:headmaster_id}/school",
	response={200: SchoolOut, 404: DetailOut},
	tags=["School"],
	summary="Get a school by HeadMaster id",
	description="Get a school by HeadMaster id",
)
